package com.lsj.mycalendar.view;
...
public class Panel extends LinearLayout {
	...
	public Panel(Context context, AttributeSet attrs) {
		...
		mDuration = a.getInteger(R.styleable.Panel_animationDuration, 500);		
		mPosition = a.getInteger(R.styleable.Panel_position, TOP);			// position defaults to BOTTOM
	...
	protected void onFinishInflate() {
		...
		mHandle = findViewById(R.id.calendar_panelHandle);
		if (mHandle == null) {
            throw new RuntimeException("Your Panel must have a View whose id attribute is 'R.id.calendar_panelHandle'");
		}
		mHandle.setOnTouchListener(touchListener);
		
		mContent = findViewById(R.id.calendar_panelContent);
		if (mContent == null) {
            throw new RuntimeException("Your Panel must have a View whose id attribute is 'R.id.calendar_panelContent'");
		}
